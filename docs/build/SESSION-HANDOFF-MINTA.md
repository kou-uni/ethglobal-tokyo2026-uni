...
## 最新の順番：ローカルで見え方を確定してから公開

mintaの指示で、Studioの反映依頼はいったん待ってもらっています。
PR #28へ待機依頼を投稿済みです（コメント `5846982185`）。
ローカル通し確認が成功したことだけで、mintaの見え方の承認済みとは扱いません。
...
公開スマホ実機でのWorld復帰・実送金は未確認。見た目の承認もまだ得ていない。
...
デプロイ手順書は準備済みですが、再開の連絡は見え方の確認後です。
