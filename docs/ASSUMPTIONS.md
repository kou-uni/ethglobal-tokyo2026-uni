...
| # | Value | Basis | Confidence |
|---|---|---|---|
| B1 | 50 requests in one night | Rounded from A5 | 🔴 |
| B2 | auto 36 / deny 12 / human 2 | Chosen so the split is legible at a glance and sums to 50 | 🔴 |
| B3 | Escalations 12 → 5 → 2 over 7 days | Illustrates the flywheel. **Not measured** | 🔴 |
...
*the input varies; what we fix is the output.*
